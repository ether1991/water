...
//>>built
 (function(_1, _2) {
    ...
    has.add = function(_1b, _1c, now, _1d) { (_1a[_1b] === undefined || _1d) && (_1a[_1b] = _1c);
        return now && has(_1b);
    };
    ...
    if (1) {
        ...
        if (has("dojo-cdn") || 1) {
            var _74 = doc.getElementsByTagName("script"),
            i = 0,
            _75,
            _76,
            src,
    ...
    _b6 = function(_b7, _b8, _b9) {
        return _b7.normalize ? _b7.normalize(_b8, 
        function(mid) {
            return _ba(mid, _b9);
        }) : _ba(_b8, _b9);
    },
                        ...
                        var _f5 = function(_f6) {
                            if (_26 == _27) {
                                ...
                                if (_f2.finish) {
                                    ...
                                    _f8 = _f2.finish;
                                    delete _f2.finish;
                                    def(_f7, ["dojo", ("dojo/require!" + _f8.join(",")).replace(/\./g, "/")], 
                                    function(_f9) {
                                        _9(_f8, 
                                        function(mid) {
                                            _f9.require(mid);
    ...
    var def = function(mid, _112, _113) {
        ...
        if (0 && args[1] === _115) {
            args[2].toString().replace(/(\/\*([\s\S]*?)\*\/|\/\/(.*)$)/mg, "").replace(/require\(["']([\w\!\-_\.\/]+)["']\)/g, 
            function(_116, dep) {
                args[1].push(dep);
            });
        }
        req.trace("loader-define", args.slice(0, 2));
        var _117 = args[0] && _32(args[0]),
        _118;
    ...
    cache: {
        "dojo/request/default": function() {
            ...
            function(_11d, _11e, has) {
                var _11f = has("config-requestProvider"),
                _120;
                if (1 || has("host-webworker")) {
                    _120 = "./xhr";
                } else {
        ...
        "dojo/_base/fx": function() {
            define(["./kernel", "./config", "./lang", "../Evented", "./Color", "../aspect", "../sniff", "../dom", "../dom-style"], 
            function(dojo, _125, lang, _126, _127, _128, has, dom, _129) {
                    ...
                    _cycle: function() {
                        ...
                        if (_13e._active) {
                            ...
                            if (_13e._percent < 1) {
                                ...
                                _13e._percent = 0;
                                _13e._fire("onEnd", [_13e.node]); ! _13e.repeat && _13e._stopTimer();
                            }
                        }
                        return _13e;
                    },
                ...
                _12b.animateProperty = function(args) {
                    ...
                    _128.after(anim, "beforeBegin", lang.hitch(anim, 
                    function() {
                        var pm = {};
        ...
        "dojo/dom-form": function() {
            define(["./_base/lang", "./dom", "./io-query", "./json"], 
            ...
            function(dojo, _15a, has, _15b, _15c, lang, xhr, json, _15d) {
                ...
                if (1) {
                    ...
                    _15e.getLocalization = function(_1bf, _1c0, _1c1) {
                        var _1c2,
                        _1c3 = _168(_1bf, _1c0, _1c1);
                        load(_1c3, (!isXd(_1c3, _15a) ? 
                        function(deps, _1c4) {
                            _1b5(deps, _1c4, _15a);
                        }: _15a), 
                        function(_1c5) {
        ...
        "dojo/promise/tracer": function() {
            define(["../_base/lang", "./Promise", "../Evented"], 
            function(lang, _1c7, _1c8) {
                "use strict";
                var _1c9 = new _1c8;
                var emit = _1c9.emit;
                _1c9.emit = null;
        ...
        "dojo/_base/html": function() {
            define(["./kernel", "../dom", "../dom-style", "../dom-attr", "../dom-prop", "../dom-class", "../dom-construct", "../dom-geometry"], 
        ...
        "dojo/_base/kernel": function() {
            define(["../has", "./config", "require", "module"], 
            function(has, _1d7, _1d8, _1d9) {
                ...
                _1de = (_1d8.map && _1d8.map[_1d9.id.match(/[^\/]+/)[0]]),
                item;
                for (p in _1de) {
                    if (_1dd[p]) {
                        _1dd[p][0] = _1de[p];
                ...
                1 || has.add("extend-dojo", 1); (Function("d", "d.eval = function(){return d.global.eval ? d.global.eval(arguments[0]) : eval(arguments[0]);}"))(dojo);
                if (0) {
        ...
        "dojo/_base/Deferred": function() {
            define(["./kernel", "../Deferred", "../promise/Promise", "../errors/CancelError", "../has", "./lang", "../when"], 
            function(dojo, _1ee, _1ef, _1f0, has, lang, when) {
                var _1f1 = function() {};
                var _1f2 = Object.freeze || 
                function() {};
        ...
        "dojo/NodeList-dom": function() {
            define(["./_base/kernel", "./query", "./_base/array", "./_base/lang", "./dom-class", "./dom-construct", "./dom-geometry", "./dom-attr", "./dom-style"], 
            function(dojo, _215, _216, lang, _217, _218, _219, _21a, _21b) {
                var _21c = function(a) {
        ...
        "dojo/query": function() {
            ...
            function(dojo, has, dom, on, _238, lang, _239, _23a) {
                "use strict";
                has.add("array-extensible", 
                function() {
                ...
                _23b(["indexOf", "lastIndexOf", "every", "some"], 
                function(name) {
                    var f = _238[name];
                    nlp[name] = function() {
                ...
                function _256(_257, _258) {
                    ...
                    _259.matches = _257.match || 
                    function(node, _25c, root) {
                        return _259.filter([node], _25c, root).length > 0;
                    };
                    _259.filter = _257.filter || 
                    function(_25d, _25e, root) {
        ...
        "dojo/has": function() {
            ...
            function(_267, _268) {
                ...
                if (!1) {
                    ...
                    has.cache = _26c;
                    has.add = function(name, test, now, _26d) { (typeof _26c[name] == "undefined" || _26d) && (_26c[name] = test);
                        return now && has(name);
                    };
        ...
        "dojo/_base/loader": function() {
            define(["./kernel", "../has", "require", "module", "../json", "./lang", "./array"], 
            function(dojo, has, _273, _274, json, lang, _275) {
                if (!1) {
                ...
                dojo.provide = function(mid) {
                    ...
                    _2bc(_2c1);
                    if (_2c0) { (_2c0.provides || (_2c0.provides = [])).push(function() {
                ...
                dojo.platformRequire = function(_2cc) {
                    var _2cd = (_2cc.common || []).concat(_2cc[dojo._name] || _2cc["default"] || []),
                    temp;
                    while (_2cd.length) {
                        ...
                        stringify: function(_2d7, _2d8, _2d9) {
                            ...
                            function _2db(it, _2dc, key) {
                                ...
                                if (it instanceof Date) {
                                    return "\"{FullYear}-{Month+}-{Date}T{Hours}:{Minutes}:{Seconds}Z\"".replace(/\{(\w+)(\+)?\}/g, 
        ...
        "dojo/_base/declare": function() {
            ...
            function(dojo, has, lang) {
                ...
                function _2ec(args, a, f) {
                    ...
                    opf,
                    pos,
                    _2f1 = this._inherited = this._inherited || {};
                ...
                function _301(_312, _313, _314) {
                    ...
                    if (_313) {
                        for (i = _318 - 1;; --i) {
                            ...
                            t = _316[i]; (t._meta ? _2f7: mix)(_315, t.prototype);
                            ctor = new Function;
        ...
        "dojo/dom": function() {
            ...
            function(has, win) {
                ...
                function(_31c, doc, _31d) {
                    if (!_31d) {
                        return false;
                    }
                    var _31e = _31d.style;
                    var _31f = ["Khtml", "O", "Moz", "Webkit"],
                    i = _31f.length,
                    name = "userSelect",
                    _320;
                    do {
        ...
        "dojo/selector/acme": function() {
            ...
            function(dom, has, _325, lang, win) {
                var trim = lang.trim;
                ...
                var _32b = function(_32c) {
                    ...
                    for (; lc = cc, cc = _32c.charAt(x), x < ql; x++) {
                        if (lc == "\\") {
                            continue;
                        }
                        if (!_336) {
                ...
                var _364 = (has("ie") < 9 || has("ie") == 9 && has("quirks")) ? 
                function(cond) {
        ...
        "dojo/dom-style": function() {
            ...
            function(has, dom) {
                ...
                var _3ab = has("ie") < 9 || (has("ie") < 10 && has("quirks")) ? 
                function(node) {
                    try {
                ...
                var _3ac = has("ie") < 9 || (has("ie") < 10 && has("quirks")) ? 
                function(node, _3ad) {
                    if (_3ad === "") {
                        _3ad = 1;
                    }
        ...
        "dojo/dom-geometry": function() {
            ...
            function(has, win, dom, _3b6) {
                ...
                geom.getMarginBox = function getMarginBox(node, _3bb) {
                    node = dom.byId(node);
                    var s = _3bb || _3b6.getComputedStyle(node),
                ...
                geom.getContentBox = function getContentBox(node, _3bc) {
                    node = dom.byId(node);
                    var s = _3bc || _3b6.getComputedStyle(node),
                    w = node.clientWidth,
                    h,
        ...
        "dojo/dom-prop": function() {
            ...
            function(_3cb, dojo, has, lang, dom, _3cc, ctr, conn) {
                var _3cd = {},
                _3ce = 0,
                _3cf = dojo._scopeName + "attrid";
                has.add("dom-textContent", 
                function(_3d0, doc, _3d1) {
        ...
        "dojo/dom-attr": function() {
            ...
            function(_3e0, has, lang, dom, _3e1, prop) {
                var _3e2 = {
                    innerHTML: 1,
                    textContent: 1,
                    className: 1,
        ...
        "dojo/dom-construct": function() {
            ...
            function(_3ee, dojo, has, win, dom, attr) {
                var _3ef = {
                    option: ["select"],
                    tbody: ["table"],
                    thead: ["table"],
                ...
                if (has("ie") <= 8) {
                    _3f5 = function(doc) {
                        ...
                        doc.body);
                        if (div.childNodes.length !== 1) { ("abbr article aside audio canvas details figcaption figure footer header " + "hgroup mark meter nav output progress section summary time video").replace(/\b\w+\b/g, 
                            function(n) {
                                doc.createElement(n);
                            });
                        }
                ...
                _3ee.toDom = function toDom(frag, doc) {
                    ...
                    frag += "";
                    var _3fd = frag.match(_3f0),
                    tag = _3fd ? _3fd[1].toLowerCase() : "",
                    _3fe = _3f1[_3fc],
                    wrap,
                    i,
                    fc,
        ...
        "dojo/request/xhr": function() {
            define(["../errors/RequestError", "./watch", "./handlers", "./util", "../has"], 
            function(_406, _407, _408, util, has) {
                has.add("native-xhr", 
                function() {
                    return typeof XMLHttpRequest !== "undefined";
                });
                has.add("dojo-force-activex-xhr", 
                function() {
                ...
                has.add("native-formdata", 
                function() {
                    return typeof FormData !== "undefined";
                });
                has.add("native-response-type", 
                function() {
                    return has("native-xhr") && typeof new XMLHttpRequest().responseType !== "undefined";
                });
                has.add("native-xhr2-blob", 
                function() {
        ...
        "dojo/text": function() {
            define(["./_base/kernel", "require", "./has", "./request"], 
            function(dojo, _42e, has, _42f) {
                var _430;
                if (1) {
        ...
        "dojo/domReady": function() {
            ...
            function(has) {
                ...
                _444 = typeof doc.readyState != "string",
                _445 = !!_443[doc.readyState],
                _446 = [],
                _447;
                function _448(_449) {
                    _446.push(_449);
        ...
        "dojo/_base/lang": function() {
            define(["./kernel", "../has", "../sniff"], 
            function(dojo, has) {
                has.add("bug-for-in-skips-shadowed", 
                function() {
                    for (var i in {
                        toString: 1
                    }) {
        ...
        "dojo/request/util": function() {
            define(["exports", "../errors/RequestError", "../errors/CancelError", "../Deferred", "../io-query", "../_base/array", "../_base/lang", "../promise/Promise"], 
            function(_46f, _470, _471, _472, _473, _474, lang, _475) {
                ...
                _46f.addCommonMethods = function addCommonMethods(_48e, _48f) {
                    _474.forEach(_48f || ["GET", "POST", "PUT", "DELETE"], 
                    function(_490) {
            ...
            function(_496, on) {
                ...
                _498.prototype = {
                    on: function(type, _499) {
                        return on.parse(this, type, _499, 
                        function(_49a, type) {
        ...
        "dojo/mouse": function() {
            define(["./_base/kernel", "./on", "./has", "./dom", "./_base/window"], 
        ...
        "dojo/_base/xhr": function() {
            define(["./kernel", "./sniff", "require", "../io-query", "../dom", "../dom-form", "./Deferred", "./config", "./json", "./lang", "./array", "../on", "../aspect", "../request/watch", "../request/xhr", "../request/util"], 
            function(dojo, has, _4a9, ioq, dom, _4aa, _4ab, _4ac, json, lang, _4ad, on, _4ae, _4af, _4b0, util) {
        ...
        "dojo/Deferred": function() {
            ...
            function(has, lang, _4de, _4df, _4e0) {
                "use strict";
                var _4e1 = 0,
                _4e2 = 1,
                _4e3 = 2;
                var _4e4 = "This deferred has already been fulfilled.";
                var _4e5 = Object.freeze || 
                function() {};
        ...
        "dojo/request/watch": function() {
            define(["./util", "../errors/RequestTimeoutError", "../errors/CancelError", "../_base/array", "../_base/window", "../has!host-browser?dom-addeventlistener?:../on:"], 
            function(util, _546, _547, _548, win, on) {
                var _549 = null,
                _54a = [];
                function _54b() {
                    var now = +(new Date);
        ...
        "dojo/on": function() {
            ...
            function(_54f, dojo, has) {
                ...
                if (1) {
                    ...
                    function(_551, doc, _552) {
                        return "onfocusin" in _552;
                    });
                    if (has("touch")) {
                        has.add("touch-can-modify-event-delegate", 
                        function() {
                            var _553 = function() {};
        ...
        "dojo/dom-class": function() {
            define(["./_base/lang", "./_base/array", "./dom"], 
            function(lang, _5cc, dom) {
                var _5cd = "className";
                var cls,
                _5ce = /\s+/,
                a1 = [""];
        ...
        "dojo/main": function() {
            define(["./_base/kernel", "./has", "require", "./sniff", "./_base/lang", "./_base/array", "./_base/config", "./ready", "./_base/declare", "./_base/connect", "./_base/Deferred", "./_base/json", "./_base/Color", "./has!dojo-firebug?./_firebug/firebug", "./_base/browser", "./_base/loader"], 
            function(_5e1, has, _5e2, _5e3, lang, _5e4, _5e5, _5e6) {
                if (_5e5.isDebug) {
                ...
                if (1) {
                    ...
                    if (deps) {
                        deps = _5e4.map(lang.isArray(deps) ? deps: [deps], 
                        function(item) {
        ...
        "dojo/ready": function() {
            define(["./_base/kernel", "./has", "require", "./domReady", "./_base/lang"], 
            function(dojo, has, _617, _618, lang) {
                var _619 = 0,
                _61a = [],
                _61b = 0,
                _61c = function() {
        ...
        "dojo/_base/connect": function() {
            define(["./kernel", "../on", "../topic", "../aspect", "./event", "../mouse", "./sniff", "./lang", "../keys"], 
            function(dojo, on, hub, _623, _624, _625, has, lang) {
                has.add("events-keypress-typed", 
                function() {
                    var _626 = {
                        charCode: 0
                    };
                    try {
                        _626 = document.createEvent("KeyboardEvent"); (_626.initKeyboardEvent || _626.initKeyEvent).call(_626, "keypress", true, true, null, false, false, false, false, 9, 3);
                    } catch(e) {}
